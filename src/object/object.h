...
public:
    ...
    bool        CreateVehicle(Math::Vector pos, float angle, CObjectType* type, float power, bool bTrainer, bool bToy);
    bool        CreateInsect(Math::Vector pos, float angle, CObjectType* type);
    bool        CreateBuilding(Math::Vector pos, float angle, float height, CObjectType* type, float power=1.0f);
    bool        CreateResource(Math::Vector pos, float angle, CObjectType* type, float power=1.0f);
    bool        CreateFlag(Math::Vector pos, float angle, CObjectType* type);
    bool        CreateBarrier(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreatePlant(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateMushroom(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateTeen(Math::Vector pos, float angle, float zoom, float height, CObjectType* type);
    bool        CreateQuartz(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateRoot(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateHome(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateRuin(Math::Vector pos, float angle, float height, CObjectType* type);
    bool        CreateApollo(Math::Vector pos, float angle, CObjectType* type);
    ...
    static DriveType GetDriveFromObject(CObjectType* type);
    static ToolType  GetToolFromObject(CObjectType* type);

protected:
    bool        EventFrame(const Event &event);
    void        VirusFrame(float rTime);
    void        PartiFrame(float rTime);
    void        CreateOtherObject(CObjectType* type);
